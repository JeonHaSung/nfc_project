import { HeartHandshake, Lightbulb, RadioTower, ShieldCheck, Users } from 'lucide-react'
    ...
    <>
      <section className="subpage-hero">
        <div className="public-container subpage-hero-inner">
          <span className="public-kicker">ABOUT TAPLINK</span>
      ...
      <section className="public-section">
        <div className="public-container story-grid">
          <div className="story-visual">
            <div className="story-symbol"><RadioTower size={44} /></div>
          ...
          <div className="section-heading story-copy">
            ...
            <p>TapLink는 오프라인에서 좋은 정보가 고객에게 닿지 못하는 문제에서 시작했습니다. 복잡한 절차 대신 스마트폰을 가볍게 태그하는 행동 하나로 매장과 제품의 이야기가 전달되도록 설계합니다.</p>
            <p>기술 자체를 드러내기보다 사용자가 가장 편안하게 느끼는 경험을 만드는 것, 그것이 TapLink가 추구하는 연결입니다.</p>
          </div>
        </div>
      </section>
