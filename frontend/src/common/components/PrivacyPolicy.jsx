...
const PRIVACY_SECTIONS = [
  {
    title: '1. 수집·이용 목적',
    body: '총판(파트너) 계정 생성 및 이메일 인증, 아이디 찾기, 비밀번호 재설정, 담당 매장 태그카드 등록 및 관리, 서비스 관련 주요 공지 전달을 위해 개인정보를 수집·이용합니다.',
  },
  {
    title: '2. 수집 항목',
  ...
  {
    title: '6. 계정 삭제',
    body: '계정 삭제 요청 또는 관리자 삭제 시 해당 계정의 개인정보는 파기(마스킹) 처리되며, 해당 계정이 등록한 매장과 소속 카드는 비활성 처리됩니다. 더 이상 이용할 수 없습니다.',
  },
]
  ...
  return (
    <div className="privacy-consent">
      ...
      <div className="privacy-consent-summary">
        <p>수집·이용 목적: 계정 생성 및 이메일 인증, 아이디 찾기, 비밀번호 재설정, 담당 매장 태그카드 등록 및 관리, 서비스 관련 주요 공지 전달</p>
