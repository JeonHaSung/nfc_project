...
public enum ErrorCode {
    ...
    DUPLICATE_EMAIL("A015", "이미 사용 중인 이메일입니다.", HttpStatus.CONFLICT),
    EMAIL_VERIFICATION_INVALID("A016", "이메일 인증 코드가 올바르지 않습니다.", HttpStatus.BAD_REQUEST),
    EMAIL_VERIFICATION_EXPIRED("A017", "이메일 인증 코드가 만료되었습니다.", HttpStatus.GONE),
    EMAIL_RESEND_COOLDOWN("A018", "인증 코드는 60초 후 다시 요청할 수 있습니다.", HttpStatus.TOO_MANY_REQUESTS),
